<?php
/**
 * IPA Fields Pack Admin Settings Handler
 *
...
class IPA_Fields_Pack_Admin_Settings_Handler {
	...
	public static function plugin_settings_ajax_save() {
		if ( ! isset( $_POST['wpnonce'] ) || ! wp_verify_nonce( $_POST['wpnonce'], 'ipa_fields_pack_menu_settings_wpnonce' ) ) {
...
add_action( "wp_ajax_ipa_fields_pack_settings_save", array(
	'IPA_Fields_Pack_Admin_Settings_Handler',
