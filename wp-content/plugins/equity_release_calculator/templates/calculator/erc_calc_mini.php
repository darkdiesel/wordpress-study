...
wp_register_script('erc_calc_mini.js', WP_PLUGIN_URL . '/equity_release_calculator/assets/js/erc_calc_mini.js');
wp_enqueue_script('erc_calc_mini.js');

wp_localize_script(
	'erc_calc_mini.js', 'er_calculator_vars',
	array(
...
$ercButtonNextStep = "";
$ercButtonNextStep .= "-moz-box-sizing: border-box; -web-box-sizing: border-box; box-sizing: border-box;";
if (get_option('erc_' . $calc['id']  .  '_next_step_button_image_enabled')) {
    $ercButtonNextStep .= "background-image: url('" . get_option('erc_' . $calc['id']  .  '_next_step_button_image_url') ."');";
}
...
<div id="erc_main_area_<?php echo $calc['id'] ?>" class="erc_continer er_panel er_panel-default" style="position: relative; <?php echo $ercMainAreaBorder, $ercMainAreaBackground, $ercCalc; ?>">
    ...
    <div id="erc_body_container" style="<?php echo $ercBorderArea; ?>">
        ...
        <div id="erc_selectable_step_one_<?php echo $calc['id']; ?>">
        ...
        <div id="erc_selectable_step_two_<?php echo $calc['id']; ?>" style="display: none;">
            <ul style="list-style: none;" class="<?php echo get_option('erc_' . $calc['id']  .  '_calc_style') ? get_option('erc_' . $calc['id']  .  '_calc_style') : 'erc_input_container_horizontal';  ?>">
                <li style="list-style: none;">
                    <ul style="list-style: none;" class="erc_input_group">
        ...
        <div id="erc_button_container_next_step_<?php echo $calc['id']; ?>" class="erc_next_step_button_container_<?php echo $calc['id']; ?>" style="">
            <a style="<?php echo $ercButtonNextStep; ?>" title="<?php echo get_option('erc_' . $calc['id']  .  '_next_step_button_image_title')?>" class="erc_next_step_button_<?php echo $calc['id']; ?>" id="erc_button_next_step_<?php echo $calc['id'];?>"  href="#"><?php echo get_option('erc_' . $calc['id']  .  '_next_step_button_text')?></a>
        </div>

        <div id="erc_button_container_calculate_<?php echo $calc['id']; ?>" class="erc_calculate_button_container_<?php echo $calc['id']; ?>" style="display: none;">
            <a onclick="window.uetq = window.uetq || []; window.uetq.push({ 'ec':'Calculator', 'ea':'Click', 'el':'Quick Calculator' });"style="<?php echo $ercButtonCalculate; ?>" title="<?php echo get_option('erc_' . $calc['id']  .  '_calculate_button_image_title')?>" class="erc_calculate_button_<?php echo $calc['id']; ?>" id="erc_button_calculate_<?php echo $calc['id'];?>"  href="#"><?php echo get_option('erc_' . $calc['id']  .  '_calculate_button_text')?></a>
        </div>
